...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["null"],      # Quién puede acceder. Al poner null es para que al hacer doble click al archivo html, lo permita
    allow_credentials=True,   # Si se permiten cookies/credenciales
    allow_methods=["*"],      # Qué métodos HTTP se permite. Luego ver si lo cambio a ["GET", "POST", "PUT", "DELETE"]
